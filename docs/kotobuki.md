...
flowchart TB
    ...
    classDef regular fill:#d7e6a3
    classDef subgraph_style fill:#D3D3D3
    
    fetch[Fetch concept relationships<br>for target concept_id]:::regular
    ...
    subgraph result[Result]
        no_cigar[At least we tried]:::regular
